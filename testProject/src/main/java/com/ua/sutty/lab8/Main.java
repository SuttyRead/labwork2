...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(cyclicCollection.getFirst().nextItem().nextItem().nextItem().nextItem().nextItem().nextItem());
        ...
        try {
            ...
            newCyclicCollection = (CyclicCollection) serializableUtils.deserialize(inputStream);
        ...
        System.out.println(Objects.requireNonNull(newCyclicCollection).getFirst().nextItem().nextItem());
    }
